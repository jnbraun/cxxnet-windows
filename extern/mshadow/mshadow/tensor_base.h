...
namespace mshadow {
    ...
    namespace sv {
        ...
        struct saveto {
			...
			MSHADOW_CONSTEXPR static int kAlphaBLAS = 1.0f;
            /*! \brief helper constant to use BLAS, beta */
			MSHADOW_CONSTEXPR static int kBetaBLAS = 0.0f;
            /*! \brief corresponding binary operator type */
            typedef op::right OPType;
        };
		/*MSHADOW_CONSTEXPR real_t saveto::kAlphaBLAS = 1.0f;
		MSHADOW_CONSTEXPR real_t saveto::kBetaBLAS = 0.0f;*/
        /*! \brief save to saver: += */
        struct plusto {
            /*! \brief save b to a using save method */
            MSHADOW_XINLINE static void Save(real_t& a, real_t b) {
			...
			MSHADOW_CONSTEXPR static int kBetaBLAS = 1.0f;
            /*! \brief corresponding binary operator type */
            typedef op::plus OPType;
        };
		/*MSHADOW_CONSTEXPR real_t plusto::kAlphaBLAS = 1.0f;
		MSHADOW_CONSTEXPR real_t plusto::kBetaBLAS = 1.0f;*/
		...
		/*MSHADOW_CONSTEXPR real_t minusto::kAlphaBLAS = -1.0f;
		MSHADOW_CONSTEXPR real_t minusto::kBetaBLAS = 1.0f;*/
    ...
    namespace red {
        ...
        struct sum {
			...
			MSHADOW_CONSTEXPR static int kInitV = 0.0f;
        };
		//MSHADOW_CONSTEXPR real_t sum::kInitV = 0.0f;
        ...
        struct maximum {
            ...
            /*! \brief an intial value of reducer */
#if MSHADOW_SINGLE_PRECISION
			MSHADOW_CONSTEXPR static int kInitV = -INT_MAX;
#else
            MSHADOW_CONSTEXPR static real_t kInitV = -DBL_MAX;
#endif
        };
		/*MSHADOW_CONSTEXPR real_t maximum::kInitV = -FLT_MAX;*/
    };
